...
function Crear-OU {
    ...
    try {
        ...
        Escribir-Log "ERROR al crear OU $OU: ${_}"
    }
}
...
function Crear-Grupo {
    ...
    try {
        ...
        Escribir-Log "ERROR al crear grupo $Grupo: ${_}"
    }
}
...
foreach ($U in $Usuarios) {
    ...
    if (-not $existeUsuario) {
        try {
            ...
            Escribir-Log "ERROR al crear usuario $($U.Usuario): ${_}"
        }
    } else {
    ...
    if ($grupoObj) {
        try {
            ...
            Escribir-Log "ERROR al añadir usuario $($U.Usuario) al grupo $($U.Grupo): ${_}"
        }
    } else {
